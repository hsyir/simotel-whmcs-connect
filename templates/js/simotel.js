...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Html__ = __webpack_require__(4);
...
var CallerId = function () {
    ...
    _createClass(CallerId, [{
        ...
        key: 'turnOnHideTimer',
        value: function turnOnHideTimer(popUpElement) {

            $(popUpElement).find(".countDownProgress").on("animationend", function (x) {
...
var Html = function () {
    ...
    _createClass(Html, [{
        ...
        value: function clientTell(callData) {
            ...
            var thisPopup = this;
            var copyBtn = $("<a class='copyBtn'>").attr("href", "#").click(function (e) {
                e.preventDefault();
                e.stopPropagation();
        ...
        value: function popupActions(callData) {
            ...
            var selectedBtns = callData.client ? this.config.selectedPopUpButtons : ["create_client"];

            var html = $("<div class='simotelBtns'>");
...
if (window.clickToDialActive) {
    $('p ,td').each(function () {
        ...
        var newContent = $(this).html().replaceAll(phoneNumberRegx, makeBalloon);
        $(this).html(newContent);
    });
    $("input[type=text],input[type=number],input[type=tel]").each(function () {
        var numbers = $(this).val().match(phoneNumberRegx);
        if (numbers != null) {
            for (var i in numbers) {
                var balloon = makeBalloon(numbers[i]);
    ...
    $('body').on("click", function (e) {
        if ($(e.target).parents(".simotelClickToDial").length > 0) return;
    ...
    $('body').on("click", ".simotelClickToDial .balloon a", function (e) {
        ...
        function setStatus(status, message) {
            var statusElement = $(balloon).find(".status");
...
function resetElHeight(el) {
    var balloonHeight = -1 * $(el).height() - 30;
...
$("document").ready(function () {
    ...
    $("form.module-configs").submit(function (e) {
        ...
        $.post($(this).attr("action"), $(this).serialize()).done(function (x) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__CallerId_CallerId__ = __webpack_require__(3);
var adminPanelUrl = window.panelWebUrl;
...
(function (e) {
  ...
  function A(t, n, i) {
    ...
    return e.is(t) ? e : e.find(t);
      ...
      E = function E(t, n) {
    var r;return r = function r() {}, r.prototype = t, e.extend(!0, new r(), n);
  },
      S = function S(t) {
    return e.extend(w, t);
  },
    ...
    }b = Math.max(0, this.options.gap - (this.options.arrowShow ? i : 0)), C(p, A, b);if (!this.options.arrowShow) this.arrow.hide();else {
